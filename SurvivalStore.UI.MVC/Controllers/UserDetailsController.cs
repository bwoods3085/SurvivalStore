...
namespace SurvivalStore.UI.MVC.Controllers
{
    public class UserDetailsController : Controller
    {
        ...
        public UserDetailsController(SurvivalStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.UserDetails != null ? 
                          ...
                          Problem("Entity set 'SurvivalStoreContext.UserDetails'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'SurvivalStoreContext.UserDetails'  is null.");
            }
            var userDetail = await _context.UserDetails.FindAsync(id);
            if (userDetail != null)
            {
